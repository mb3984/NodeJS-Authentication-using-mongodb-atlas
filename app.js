...
const initializeDBAndServer = async () => {
  const username = encodeURIComponent("madhubabuTeki");
  const password = encodeURIComponent("madhu12babu");
  const uri = `mongodb+srv://${username}:${password}@cluster0.prdx1ha.mongodb.net/authentication?retryWrites=true&w=majority`;
